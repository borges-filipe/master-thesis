...
\begin{figure}[H]
	...
	\caption{Sketch of phase 1 of implementation plan including hallucination detection and creation of dataset consisting of detected hallucinatory captions.}
	\label{fig:phase1}
\end{figure}

\begin{figure}[H]
	\includesvg[width=\linewidth]{figures/phase2.drawio.svg}
	\caption{Sketch of phase 2 of implementation plan where the hallucinatory dataset created in the first phase will be used to train a hallucination reviser in the style of LURE \cite{zhouAnalyzingMitigatingObject2024}.}
	\label{fig:phase2}
\end{figure}
