...
Most research has focused on general Computer Vision images and significant work remains to explore hallucinations in image-captioning using LVLMs and to adapt existing methods to Remote Sensing. % While there exists some work exploring hallucinations in aerial imagery, researchers have had to rely on very laborious manual analysis of generated captions due to lack of automatic hallucination detection \cite{basakAerialMirageUnmasking}. Bringing reliable automatic hallucination-detection techniques over to the domain of Remote Sensing would be an important step to accelerate further research.
