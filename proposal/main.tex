...
\begin{figure}[H]
	\includesvg[width=\linewidth]{figures/phase2.drawio.svg}
	\caption{Phase 2 of implementation plan where the hallucinatory dataset created in the first phase will be used to train a hallucination reviser in the style of LURE \cite{zhouAnalyzingMitigatingObject2024}.}
	\label{fig:phase2}
\end{figure}
