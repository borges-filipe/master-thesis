...
This thesis will consist of two phases, both phases are illustrated in Figures \ref{fig:phase1} and \ref{fig:phase2} respectively. The first phase will be an exploration of two training-free hallucination detection methods: Semantic Entropy \cite{farquharDetectingHallucinationsLarge2024} and Visual Contrastive Decoding \cite{lengMitigatingObjectHallucinations2024}. In this phase, the performance of these methods will be evaluated on Remote Sensing datasets with VLM-generated captions. As both methods rely on VLMs, different models will be tested to see how model choice affects detection performance. Detected hallucinations will be collected and revised in order to create a dataset of detected VLM hallucinations in Remote Sensing image captions. In the second phase, the created dataset will be used to train a hallucination reviser similarly to LURE \cite{zhouAnalyzingMitigatingObject2024}.
